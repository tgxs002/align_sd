...
### Inference
We host [a Web demo using Gradio on Hugging Face](https://huggingface.co/spaces/xswu/align_sd), you can easily try it out without setting up the environment.

If you prefer inferring locally, you will need to have [diffusers](https://huggingface.co/docs/diffusers/index) and [pytorch](https://pytorch.org/) installed in your environment.
